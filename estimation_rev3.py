...
# データの読み込み
data = pd.read_csv('encoded/encoded_data_rev1_3.csv', encoding='Shift-JIS')
#着順を変換
...
data = data[data['人気'] == 1]
data = data.drop(['馬場1', '芝・ダート1', '斤量1','距離1', 'クラス1', 'race_id', '騎手', '騎手1', '乗り替わり','芝・ダート替わり','人気', 'クラス差', '場名'], axis=1)
# data = data[data['人気'] == 1]
...
# モデルの保存
lgb_clf.booster_.save_model('model/model_rev3.txt')
